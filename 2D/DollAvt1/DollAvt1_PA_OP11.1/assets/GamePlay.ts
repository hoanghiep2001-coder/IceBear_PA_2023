...
export default class NewClass extends cc.Component {
    ...
    private registerEvent(): void {
        this.bg_Horizontal.on(cc.Node.EventType.TOUCH_START, () => {
            ...
            this.CharacterGlass.getComponent(cc.Animation).stop();
            this.CharacterGlass.scaleX = 1;
            this.CharacterGlass.scaleY = 1;
        ...
        this.Hints[1].on(cc.Node.EventType.TOUCH_START, () => {
            ...
            this.CharacterBackHair[1].active = true;
    ...
    private setIphoneX(): void {
        this.dollBase.scaleX = 0.26;
        this.dollBase.scaleY = 0.26;
        this.dollBase.y = 48;
        this.dollBase.x = 0;
    ...
    private setMobile(): void {
        if(cc.view.getFrameSize().height / cc.view.getFrameSize().width > 1.5) {
            ...
            this.dollBase.scaleX = 0.28;
            this.dollBase.scaleY = 0.28;
            this.dollBase.y = 90;
            this.dollBase.x = 0;

            this.bg_FrameText.scaleX = 0.5;
            this.bg_FrameText.scaleY = 0.5;
            this.bg_FrameText.y = -208;
            this.bg_FrameText.x = 0;

            this.framePickItem.scaleX = 0.28;    
            this.framePickItem.scaleY = 0.32;
            this.framePickItem.y = -135;
            this.framePickItem.x = 0;

            this.text_Frame.scaleX = 0.6;   
            this.text_Frame.scaleY = 0.6;
            this.text_Frame.y = 200;
            this.text_Frame.x = 0;
        }
    }
    ...
    private handleGamePlay(): void {
        ...
        this.scheduleOnce(() => {
            this.CharacterGlass.getComponent(cc.Animation).play("Blink");
        }, 1);
    ...
    private setHorizontalForTablet(): void {
        this.dollBase.scaleX = 0.44;
        this.dollBase.scaleY = 0.44;
        this.dollBase.y = -60;
        this.dollBase.x = -135;
        ...
        this.text_Frame.scaleX = 0.3;
        this.text_Frame.scaleY = 0.3;
        this.text_Frame.y = -100;
        this.text_Frame.x = -360;

        this.framePickItem.scaleX = 0.22;
        this.framePickItem.scaleY = 0.27;
        this.framePickItem.y = -50;
