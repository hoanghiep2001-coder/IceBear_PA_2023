...
export default class Responsive extends cc.Component {
    ...
    private setHorizontalForIpX(): void {
        ...
        // this.GamePlay.point.getComponent(cc.Animation).stop();
        // this.GamePlay.point.getComponent(cc.Animation).play("PointHorizontal_Anim");
...
this.GamePlay.icon.active = true;
    ...
    private setIphoneX(): void {
        ...
        // this.GamePlay.point.getComponent(cc.Animation).stop();
        // this.GamePlay.point.getComponent(cc.Animation).play("Point_Anim");
