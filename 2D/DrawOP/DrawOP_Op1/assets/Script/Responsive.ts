...
export default class Responsive extends cc.Component {
    ...
    private setHorizontalForIpX(): void {
        ...
        if(cc.view.getFrameSize().height / cc.view.getFrameSize().width > 0.55) {
            // Ip 6 / 6Plus / 7 / 7 Plus
            this.GamePlay.background.scale = 0.71
            this.GamePlay.background.y = -250;
        } else {
            // IpX
            this.GamePlay.background.scale = 0.71
            this.GamePlay.background.y = -250;
    ...
    private setHorizontalForTablet(): void {
        ...
        this.GamePlay.background.scale = 0.45
        this.GamePlay.background.y = -80;
    }
    ...
    private setIphoneX(): void {
        ...
        this.GamePlay.background.scale = 0.4
    ...
    private setMobile(): void {
        ...
        if(cc.view.getFrameSize().width / cc.view.getFrameSize().height < 0.7) {
           ...
           this.GamePlay.background.scale = 0.3;
           this.GamePlay.background.y = 0;
        } else {    
