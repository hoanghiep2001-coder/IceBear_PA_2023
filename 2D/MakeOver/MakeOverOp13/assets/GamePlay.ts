...
export default class GamePlay extends cc.Component {
  ...
  private registerEvent(): void {
    this.BackGround.on(cc.Node.EventType.TOUCH_START, this.handleBgTouchStart, this);
    this.bg_Hospital.on(cc.Node.EventType.TOUCH_START, this.handleBgTouchStart, this);

    // others
    this.tweezersEmptyNode.on(cc.Node.EventType.TOUCH_START, this.handleTouchStartTweezers, this);
    this.tweezersEmptyNode.on(cc.Node.EventType.TOUCH_MOVE, this.handleTouchMoveTweezers, this);
    this.bg_Hospital.on(cc.Node.EventType.TOUCH_MOVE, this.handleTouchMoveBgHospotal, this);
    this.bg_Hospital.on(cc.Node.EventType.TOUCH_END, this.handleTouchEndBgHospotal, this);
  ...
  private handleTouchStartTweezers(e: cc.Touch): void {
    if(this.isDone) {
      console.log("install");
      cc.audioEngine.stopAll();
      this.node.getComponent("GameController").installHandle();
  ...
  private handleTouchMoveTweezers(e: cc.Touch): void {
    this.hand.active = false;
  ...
  private handleTouchEndBgHospotal(): void {
    if(!this.isTouched) return;
  ...
  private handleTouchMoveBgHospotal(): void {
    this.moveDirection.active = false;
