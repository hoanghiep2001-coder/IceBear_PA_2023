...
export default class GamePlay extends cc.Component {
  ...
  registerEvent(): void {
    this.creamEmptyNode.on("touchstart", (e: cc.Touch) => {
      ...
      if(Constants.ironSource.SoundState) {
        Constants.cleanSoundState = cc.audioEngine.play(this.AudioManager.creamWash, true, 1);
      }
    });
    ...
    this.creamEmptyNode.on(cc.Node.EventType.TOUCH_END, (e: cc.Touch) => {
      if(Constants.ironSource.SoundState) {
    ...
    this.creamEmptyNode.on(cc.Node.EventType.TOUCH_CANCEL, (e: cc.Touch) => {
      if(Constants.ironSource.SoundState) {
        cc.audioEngine.stop(Constants.cleanSoundState);
      }
