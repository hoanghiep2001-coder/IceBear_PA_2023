...
cc.Class({
    ...
    onLoad() {
        ...
        physics_manager.gravity = cc.v2(0, -200);
        ...
        if (this.Bg_audio_Id == null) {
            ...
            setTimeout(() => {
                ...
                if (this.CheckClick == false) {
                    ...
                    this.BgBoss_audio_Id = cc.audioEngine.play(this.Boss_Audio, true, 1);
                }
    ...
    update() {
        ...
        this.Bg_boss.width = cc.winSize.width;
        this.Bg_boss.height = cc.winSize.height;
