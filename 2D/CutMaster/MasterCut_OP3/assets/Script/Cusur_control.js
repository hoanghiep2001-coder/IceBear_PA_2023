...
cc.Class({
    ...
    properties: {
        ...
        KingKong_control: require('KingKong_control'),
    ...
    Event_Mouse_MoveRopeMan() {
        ...
        cc.audioEngine.stop(this.Main_control.Boss_audio_Id);
    ...
    onBeginContact(contact, selfCollider, otherCollider) {
        ...
        if (otherCollider.getComponent(cc.PhysicsBoxCollider).tag == 10) {
        ...
        } else if (otherCollider.getComponent(cc.PhysicsBoxCollider).tag == 20) {
    ...
    update(dt) {
        ...
        this.CutRopeMan = this.KingKong_control.CutRopeMan;
