...
export default class Responsive extends cc.Component {
    ...
    private configVertical(): void {
        ...
        this.GamePlay.checkPoint_3.x = 150;
        this.GamePlay.checkPoint_3.y = -31;

        this.GamePlay.Fence.x = -18.18;
        this.GamePlay.Fence_Top.x = -5;
        this.GamePlay.Fence_Top.width = 150;
        this.GamePlay.FenceFoot.x = -92;
        this.GamePlay.Fence_Left.x = -79;
        this.GamePlay.Fence_Bottom.x = -18;
        this.GamePlay.Fence_Bottom.width = 130;
    ...
    private configHorizontal(): void {
        ...
        this.GamePlay.checkPoint_3.x = 250;
        this.GamePlay.checkPoint_3.y = -31;
        ...
        this.GamePlay.Fence_Bottom.x = -16;
        this.GamePlay.Fence_Bottom.width = 320;
