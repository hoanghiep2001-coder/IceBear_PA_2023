...
cc.Class({
    ...
    StartAudio() {
        ...
        if (this.AudioBg_Id == null) {
            this.AudioBg_Id = cc.audioEngine.play(this.BgAudio, true, 1);
        }
    ...
    update(dt) {
        ...
        //     this.ViewGameDoc.scaleX = 0.8;
        //     this.ViewGameDoc.scaleY = 0.8;
        //     console.log("Check");
        // } else {
        //     this.ViewGameDoc.scaleX = 1;
        //     this.ViewGameDoc.scaleY = 1;
        //     console.log("check2");
        // }
