...
export default class NewClass extends cc.Component {
   ...
   DressItems: cc.Node[] = [];  
    ...
    protected start(): void {
        cc.audioEngine.play(this.bgSound, true, 2);
    ...
    private registerEvent(): void {
        ...
        this.HairItems.forEach((item, index) => {
            item.on(cc.Node.EventType.TOUCH_START, () => {
                ...
                cc.audioEngine.play(this.clickSound, false, 2);
                this.clickStep++;
    ...
    private setIphoneX(): void {
        this.dollBase.scaleX = 0.5;
        this.dollBase.scaleY = 0.5;
        this.dollBase.y = 58;
        this.dollBase.x = 0;

        this.framePickItem.scaleX = 0.22;
        this.framePickItem.scaleY = 0.22;
    ...
    private setMobile(): void {
        if(cc.view.getFrameSize().height / cc.view.getFrameSize().width > 1.5) {
            ...
            this.dollBase.scaleX = 0.52;
            this.dollBase.scaleY = 0.52;
            this.dollBase.y = 70;
            this.dollBase.x = 0;

            this.framePickItem.scaleX = 0.26;    
            this.framePickItem.scaleY = 0.26;
            this.framePickItem.y = -165;
            this.framePickItem.x = 0;
        }
    }
    ...
    private setHorizontalForIpX(): void {
        ...
        && cc.view.getFrameSize().height / cc.view.getFrameSize().width < 6.5) {
            this.dollBase.scaleX = 0.75;
            this.dollBase.scaleY = 0.75;
            this.dollBase.y = -20;
            this.dollBase.x = -250;
            ...
            this.framePickItem.scaleX = 0.45;
            this.framePickItem.scaleY = 0.45;
            this.framePickItem.y = -50;
            this.framePickItem.x = 140;
        }
    }
