...
export default class GamePlay extends cc.Component {
    ...
    private handleStepOne(option: number): void {
        ...
        cc.audioEngine.play(this.AudioManager.smileSound_1, false, 1);
    ...
    private handleStepTwo(option: number): void {
        ...
        cc.audioEngine.play(this.AudioManager.smileSound_2, false, 1);
    ...
    private handleBgTouchStart(locate: cc.Touch): void {
        // mtg & applovin
        // if(this.step >= 2) {
        //     this.GameController.installHandle();
        // } 
