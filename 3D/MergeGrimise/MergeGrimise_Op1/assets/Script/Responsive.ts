...
export class Responsive extends Component {
    ...
    private setHorizontalForIpX(): void {
        ...
        this.GamePlay.hint_Text.setScale(new math.Vec3(0.1, 0.1, 0.1));
        this.GamePlay.hint_Text.setPosition(new math.Vec3(0, -55, 0));
        this.GamePlay.hint_Text.getComponent(Animation).play("Blink_Tablet_Anim");
    }
    ...
    private setHorizontalForTablet(): void {
        ...
        this.GamePlay.hint_Text.setScale(new math.Vec3(0.1, 0.1, 0.1));
        this.GamePlay.hint_Text.setPosition(new math.Vec3(0, -90, 0));
        this.GamePlay.hint_Text.getComponent(Animation).play("Blink_Tablet_Anim");
    }
    ...
    private setIphoneX(): void {
        ...
        this.GamePlay.hint_Text.setScale(new math.Vec3(0.3, 0.3, 0.3));
        this.GamePlay.hint_Text.setPosition(new math.Vec3(0, -225, 0));
        this.GamePlay.hint_Text.getComponent(Animation).play("Blink_Mobile_Anim");
    }
    ...
    private setMobile(): void {
        ...
        if(view.getFrameSize().height / view.getFrameSize().width > 1.5) {
            ...
            this.GamePlay.hint_Text.setScale(new math.Vec3(0.3, 0.3, 0.3));
            this.GamePlay.hint_Text.setPosition(new math.Vec3(0, -185, 0));
            this.GamePlay.hint_Text.getComponent(Animation).play("Blink_Mobile_Anim");
            ...
            this.GamePlay.hint_Text.setScale(new math.Vec3(0.3, 0.3, 0.3));
            this.GamePlay.hint_Text.setPosition(new math.Vec3(0, -145, 0));
            this.GamePlay.hint_Text.getComponent(Animation).play("Blink_Mobile_Anim");
        }
    }
