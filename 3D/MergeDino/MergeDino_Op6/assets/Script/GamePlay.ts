...
export class GamePlay extends Component {
    ...
    private handleGamePlay(): void {
        ...
        this.dino_Rap.getComponent(SkeletalAnimation).play("Rap|IdleA");
        this.rangersBaby.forEach(ranger => {
            ranger.getComponent(Animation).play("Comp|IdleA");     
        });
    }
    ...
    private handleFight(): void {
        ...
        this.dino_Rap.getComponent(SkeletalAnimation).play("Rap|IdleAtk1");
        ...
        this.scheduleOnce(() => {
            ...
            this.dino_Rap.getComponent(SkeletalAnimation).play("Rap|Die");
    ...
    private registerEvent(): void {
            this.canvas2D.on(Node.EventType.TOUCH_END, () => {
                if(this.isMerged) {
                    ...
                    this.dinoComponent.forEach(component => {
                ...
                this.scheduleOnce(() => {
                    this.dinoBabyMerge.forEach(ranger => {
                        ranger.active = false;  
                    });
    ...
    private handleEndGame(): void {
        this.rangersBaby.forEach((baby, index) => {
            baby.active = true;
            baby.getComponent(SkeletalAnimation).play("Comp|IdleA");
